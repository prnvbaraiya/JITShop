    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/admin/advertisment/{{ $advertisment->id }}" enctype="multipart/form-data" method="post">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="url" placeholder="Enter Advertisments Url"
                                        value="{{ old('url') ?? $advertisment->url }}" class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="position" class="form-control">
                                            <option value="left" @if ($advertisment->position == 'left') selected @endif>Left
                                            </option>
                                            <option value="right" @if ($advertisment->position == 'right') selected @endif>Right
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="duration"
                                        ...
                                        value="{{ $advertisment->duration ?? old('duration') }}" class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 ml-3">
                                    ...
                                    <label class="custom-file-label"
                                        for="customFile">{{ substr($advertisment->image, 22) }}</label>
                                </div>
                            </div>
                            @error('image')
                                <div class="error text-danger">{{ $message }}</div>
