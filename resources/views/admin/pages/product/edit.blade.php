        ...
        <form class="form-sample" enctype="multipart/form-data" method="post">
            ...
            @foreach(array_keys($selectedAttributes) as $selectedAttribute)
                <div class="row mt-4">
                    <div class="col-sm-9">
                        <div class="row mt-4">
                            <label class="ms-2 col-sm-3 col-form-label text-capitalize">{{$attributes->find($selectedAttribute)->name}}</label>
                            ...
                            @for($i=0;$i<count($values);$i++)
                                <input type="checkbox" class="me-1" name="attributeArr[{{$selectedAttribute}}][]" value="{{$i}}"
                                @if(in_array($i,$selectedValues))
                                    checked
                                @endif
                                ><label class="me-3">{{$values[$i]}}</label>
                            @endfor
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12 mt-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 ml-3">
                        ...
                        <label class="custom-file-label" for="customFile">{{substr($product->image,18)}}</label>
                    </div>
                </div>
